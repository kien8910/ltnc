...
final public class Matrix {
    ...
    // create matrix with all elements = value
    ...
    public Matrix multiply(Matrix B) {
    	Matrix A = this;
        if (B.M != A.N ) throw new RuntimeException("Illegal matrix dimensions.");
...
>>>>>>> 8af4bdc68a8d80b74a210e6d6270da1d982cb07a
}